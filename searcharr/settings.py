...
# Sonarr
sonarr_enabled = True
sonarr_url = "http://172.23.0.51:8989"  # http://172.23.0.51:8989
sonarr_api_key = ""
...
sonarr_series_paths = ["/tv"]  # e.g. ["/tv", "/anime"] - can be full path or id value - leave empty to enable all
...
# Radarr
radarr_enabled = True
radarr_url = "http://172.23.0.52:7878"  # http://172.23.0.52:7878
radarr_api_key = ""
...
radarr_movie_paths = ["/movies"]  # e.g. ["/movies", "/other-movies"] - can be full path or id value - leave empty to enable all